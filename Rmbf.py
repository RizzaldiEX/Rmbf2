...
def jalankan():
	os.system("Rmbf.py" if os.name == "nt" else "python2 Rmbf.py")
...
def login_():
  try:
	print h+"\n\n  T R A Y A  M A N J I  H A C K E R  G A N G "
	print a+"+----------------------------------------"
...
if __name__=="__main__":
 ...
 /  \ /  \| __ \   __\ 
/    Y    \ \_\ \  |   
\____|__  /___  /__|  """+p+""" Author"""+h+""": Rizzaldi EX
        \/    \/       
    """
	print a+" ["+k+"@"+a+"]"+p+" Hai anjg:",k+nama
	print h+"+----------------------------------------------"
